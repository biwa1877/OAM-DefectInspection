...
% defect position
rangey = 90:92;   % centered on a contact
rangex = 116:118;
...
ax(1)= subplot(231);imagesc(abs(maskDefect12));axis image off;
caxis([cmin*0.8 cmax*1]);colormap hot;
ax(2)= subplot(234);imagesc(abs(maskDefect21));axis image off;
caxis([cmin*0.8 cmax*1]);colormap hot;
ax(3)= subplot(235);imagesc(abs(maskDefect22));axis image off;
caxis([cmin*0.8 cmax*1]);colormap hot;
ax(4)= subplot(236);imagesc(abs(maskDefect23));axis image off;
caxis([cmin*0.8 cmax*1]);colormap hot;
ax(5)= subplot(232);imagesc(abs(maskDefect32));axis image off;
caxis([cmin*0.8 cmax*1]);colormap hot;
ax(6)= subplot(233);imagesc(abs(maskDefect41));axis image off;
caxis([cmin*0.8 cmax*1]);colormap hot;
