...
ax(3) = subplot_er(sz1,sz2,v+3);imagesc(log(abs(det1)));axis image xy off;title('Diffraction Patterns','FontSize',18)
ax(4) = subplot_er(sz1,sz2,v+3+2*sz2);imagesc(log(abs(det2)));axis image xy off

ax(5) = subplot_er(sz1,sz2,v+7+sz2);imagesc(abs(diff));axis image xy off;title('Difference','FontSize',18)
